...
1. Install Cygwin, or update any existing installation in C:\Cygwin
...
Do not delete the cloned repo after installation, as the various bash scripts will be referenced directly out of this clone (only a wrapper script is added to your home directory).
