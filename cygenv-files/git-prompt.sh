...
fillers=""
for ((i=0; i<400; ++i)); do fillers="$fillers-"; done
...
draw_line() {
    ...
    ps1pc_end="$fill$ps1pc_end"
}

BLUE="\[\033[0;34m\]"
RED="\[\033[0;31m\]"
RED_BLINK="\[\033[4;1;31m\]"
LIGHT_RED="\[\033[1;31m\]"
WHITE="\[\033[1;37m\]"
NO_COLOUR="\[\033[0m\]"
LIGHT_GRAY="\[\033[4;37m\]"
...
__git_ps1 ()
{
	...
	if [ "true" = "$inside_gitdir" ]; then
		...
		then
            u="%${ZSH_VERSION+%}"
            #ucount=`git ls-files --others --exclude-standard --error-unmatch | wc -l`
			u="%$ucount"
		fi
